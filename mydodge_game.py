...
while running:
    ...
    if not game_over:
        ...
        # Check if Object 1 leaves screen
        if object_y > HEIGHT:
            object_y = -object_height
            object_x = random.randint(0, WIDTH - object_width)
            score += 1
            
        # Check if Object 2 leaves screen
        if object2_y > HEIGHT:
            object2_y = -object_height
            object2_x = random.randint(0, WIDTH - object_width)
            score += 1
            
        # Check if Object 3 leaves screen
        if object3_y > HEIGHT:
            object3_y = -object_height
            object3_x = random.randint(0, WIDTH - object_width)
            score += 1

        # Define Hitboxes (Rects)
        ...
        # Collision Detection & Life Deductions
